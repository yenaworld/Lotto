...
public class ExcelReader {
    ...
    private int getCellValue(HSSFCell curCell, XSSFCell curCell){
        int value;
        switch (curCell.getCellType()) {
            case HSSFCell.CELL_TYPE_FORMULA:
                value = Integer.parseInt(curCell.getCellFormula());
    ...
    private void setVo(NumberVo vo, int cellIndex, int value){
        switch (cellIndex) {
            case 0:
                vo.setIndex(value); break;
            case 1:
                vo.setOne(value); break;
            case 2:
                vo.setTwo(value); break;
            case 3:
                vo.setThree(value); break;
            case 4:
                vo.setFour(value); break;
            case 5:
                vo.setFive(value); break;
            case 6:
                vo.setSix(value); break;
            case 7:
                vo.setBonus(value); break;
            default: break;
        }
    }
}
